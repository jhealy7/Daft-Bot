...
Label(master, background="#6ffc6e", font ="Verdana 10 bold", text="Name").place(x=500, y=50)
Label(master, background="#6ffc6e", font ="Verdana 10 bold", text="Email Address").place(x=475, y= 100)
Label(master, background="#6ffc6e", font ="Verdana 10 bold", text="Phone Number").place(x=475, y=150)
Label(master, background="#6ffc6e", font ="Verdana 10 bold",text="Your Message").place(x=475, y=200)
